...
class Symbol:
    ...
    __slots__ = (
        ...
        "has_prize",
        "prize",
        # Prism Path additions: a beast carries a firing direction; any multiplier-wild
        # cell (beast cell or path cell) carries beast_mults = {beast_id: multiplier} so
